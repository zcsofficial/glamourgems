                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <?php if ($username): ?>
                                <div class="text-gray-700">Welcome, <?php echo $username; ?></div>
                            <?php else: ?>
                            ...
                            <button id="cartBtn" class="w-10 h-10 flex items-center justify-center text-gray-700 hover:text-primary relative" onclick="location.href='cart.php'">
                                ...
                                <span class="absolute -top-1 -right-1 w-5 h-5 bg-primary text-white text-xs rounded-full flex items-center justify-center"><?php echo $cart_count; ?></span>
                            </button>
                        </div>
                    </div>
                </div>
